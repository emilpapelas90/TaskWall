 ...
 <ul class="mb-4 flex flex-col gap-2">
  ...
  <li>
   <x-nav-link :href="route('placements')" :active="request()->routeIs('placements')">
    ...
    <p class="block antialiased font-sans text-base leading-relaxed text-inherit font-medium capitalize">{{ __('Placements') }}</p>
   </x-nav-link>
  </li>
  ...
  <li>
   <x-nav-link :href="route('ad_dashboard')" :active="request()->routeIs('ad_dashboard')">
    ...
    <p class="block antialiased font-sans text-base leading-relaxed text-inherit font-medium capitalize">{{ __('Overview') }}</p>
   </x-nav-link>
  </li>
  ...
  <li>
   <x-nav-link :href="route('funds')" :active="request()->routeIs('funds')">
    <x-ri-wallet-3-fill class="w-5 h-5 mr-2 text-blue-gray-500 transition duration-75 group-hover:text-blue-gray-500 @if(request()->routeIs('funds')) text-white @endif"/>
    <p class="block antialiased font-sans text-base leading-relaxed text-inherit font-medium capitalize">{{ __('Add Funds') }}</p>
   </x-nav-link>
  </li>
